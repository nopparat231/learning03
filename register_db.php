...
if ($numemail > 0 ){ ?>
	...
	//เพิ่มเข้าไปในฐานข้อมูล
      ...
      $user_date = date('Y-m-d', strtotime('+2 years', strtotime($d)));
			...
			$ma = "http://disaster.sharelearningmedia.com/register_db_active.php?sid=".$session_id."&ID=".$ID."<br>";
   ...
   if($result1){
     ...
     $to = $email;
     $subject = "ยืนยันการสมัครสมาชิกดเว็บ disaster.sharelearningmedia.com";
     $message = $massage;
     $headers = "From:" . $from . "\r\n";
