   <div class="col-md-3">
   	<ul class="list-group">
        ...
        <!--  <a href="index.php?showchoice_s"class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action">คำถามทั้งหมด <i class="fa fa-sign-out text-muted fa-lg"></i></a> -->
         <a href="index.php?in" class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action"> ข้อมูลคะแนน <i class="fa fa-list-ol text-muted fa-lg"></i></a>
